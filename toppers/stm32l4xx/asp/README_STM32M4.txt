	...
	TOPPERS/ASP Kernel（Release 1.9.4.1）STM32F4/L4
		Toyohashi Open Platform for Embedded Real-Time Systems/
		Advanced Standard Profile Kernel

TOPPERS/ASP STM32M4は以下の９つのボードのGCCの開発環境に対応します．
...
1.9.x バージョン履歴
	...
	2018年xx月xx日	Release	1.9.4.1		STM32L4R5 nucleo 144 ボード対応
