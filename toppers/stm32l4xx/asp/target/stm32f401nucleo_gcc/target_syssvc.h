 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_syssvc.h 698 2015-12-17 13:59:20Z roi $
 */

/*
 *  システムサービスのターゲット依存部（stm32f401-nucleo用）
 *
 ...
 *  システムクロックの定義
 */
#define SystemFrequency     84000000
#define SysFreHCLK          84000000	/* HCLK = MasterClock / 1 */
#define SysFrePCLK1         42000000	/* PCLK1 = HCLK / 2 */
#define SysFrePCLK2         84000000	/* PCLK2 = HCLK / 1 */
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME    "stm32f401-nucleo(Cortex-M4)"
