 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_serial.h 698 2016-06-14 13:59:10Z roi $
 */
...
/*
 *  チップ依存モジュール（stm32f446-nucleo144用）
 */
...
#define TADR_U2_GPIO_BASE  TADR_GPIOG_BASE
...
#define ENABLE_U1_GPIO     RCC_AHB1ENR_GPIODEN
#define ENABLE_U2_GPIO     RCC_AHB1ENR_GPIOGEN
#define TX1_PINPOS         8
#define RX1_PINPOS         9
#define TX2_PINPOS         14
#define RX2_PINPOS         9
#define U1_GPIOSPEED       GPIO_Speed_100MHz
#define U2_GPIOSPEED       GPIO_Speed_100MHz
#define GPIO_U2_AF         GPIO_AF8
