 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_syssvc.h 698 2016-06-14 14:04:40Z roi $
 */

/*
 *  システムサービスのターゲット依存部（stm32f446-nucleo144用）
 *
 ...
 *  システムクロックの定義
 */
#define SystemFrequency     180000000
#define SysFreHCLK          180000000	/* HCLK = MasterClock / 1 */
#define SysFrePCLK1         45000000	/* PCLK1 = HCLK / 4 */
#define SysFrePCLK2         90000000	/* PCLK2 = HCLK / 2 */
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME    "stm32f446-nucleo-144(Cortex-M4)"
