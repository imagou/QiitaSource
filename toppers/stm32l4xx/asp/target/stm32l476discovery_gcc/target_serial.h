 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_serial.h 698 2017-08-06 15:41:58Z roi $
 */
...
/*
 *  チップ依存モジュール（stm32l476-discovery用）
 */
...
#define ENABLE_U1_GPIO     RCC_AHB2ENR_GPIODEN
#define TADR_U2_GPIO_BASE  TADR_GPIOB_BASE
...
#define ENABLE_U2_GPIO     RCC_AHB2ENR_GPIOBEN
#define TX1_PINPOS         5
#define RX1_PINPOS         6
#define TX2_PINPOS         6
#define RX2_PINPOS         7
