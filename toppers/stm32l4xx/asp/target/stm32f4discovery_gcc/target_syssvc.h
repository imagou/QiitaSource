 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_syssvc.h 698 2015-07-27 22:42:20Z roi $
 */

/*
 *  システムサービスのターゲット依存部（stm32f4-discovery用）
 *
...
#define SysFreHCLK          168000000	/* HCLK = MasterClock / 1 */
#define SysFrePCLK1         42000000	/* PCLK1 = HCLK / 4 */
#define SysFrePCLK2         84000000	/* PCLK2 = HCLK / 2 */
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME    "stm32f4-discovery(Cortex-M4)"
