 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_syssvc.h 698 2018-11-09 18:00:00Z roi $
 */

/*
 *  システムサービスのターゲット依存部（stm32f446-nucleo64用）
 *
...
#define SysFrePCLK2         90000000	/* PCLK2 = HCLK / 1 */
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME    "stm32f446-nucleo-64(Cortex-M4)"
