 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_syssvc.h 698 2018-08-27 14:34:46Z roi $
 */

/*
 *  システムサービスのターゲット依存部（stm32l4r5-nucleo144用）
 *
...
#define SRAM2_SIZE          (64*1024)	/* SRAM2 size */
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME    "stm32fl4r5-nucleo-144(Cortex-M4)"

/*
 *  起動メッセージの著作権表示
 */
#define TARGET_COPYRIGHT \
"Copyright (C) 2016-2018 by Education Working Group TOPPERS PROJECT\n" \
