 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_serial.h 698 2015-08-12 18:37:31Z roi $
 */
...
#define TOFF_U2_APBNER     TOFF_RCC_APB1ENR
#define ENABLE_U1_PORT     RCC_APB1ENR_USART3EN
#define ENABLE_U2_PORT     RCC_APB1ENR_USART2EN
#define ENABLE_U1_GPIO     RCC_AHB1ENR_GPIOBEN
#define ENABLE_U2_GPIO     RCC_AHB1ENR_GPIODEN
...
#define USART2_BASE        TADR_USART2_BASE
...
#define INHNO_SIO2      IRQ_VECTOR_USART2
#define INTNO_SIO2      IRQ_VECTOR_USART2
